...
import type { CompletionLP, BranchContext, ModelInfo, RunParameters, TokenLP, ChatMessage } from "@/types/logprob";
...
const buildMockCompletion = (modelId: string): CompletionLP => ({
  text:
    "The Burj Khalifa in Dubai is currently the world's tallest building, measuring 828 meters (2,717 feet) in height.",
  tokens: [
...
const Playground = () => {
  ...
  const [currentCompletion, setCurrentCompletion] = useState<CompletionLP | null>(seed);
